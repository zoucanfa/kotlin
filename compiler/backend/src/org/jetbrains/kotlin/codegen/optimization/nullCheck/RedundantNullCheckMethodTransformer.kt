...
class RedundantNullCheckMethodTransformer : MethodTransformer() {
    ...
    private class TransformerPass(val internalClassName: String, val methodNode: MethodNode) {
        ...
        fun run(): Boolean {
            val relatedReferenceTypes = analyzeTypesAndRemoveDeadCode()
            eliminateRedundantChecks(relatedReferenceTypes)
        ...
        private fun eliminateRedundantChecks(relatedReferenceTypes: Map<AbstractInsnNode, Type>) {
            val nullabilityAssumptions = injectNullabilityAssumptions(relatedReferenceTypes)
        ...
        private fun injectNullabilityAssumptions(relatedReferenceTypes: Map<AbstractInsnNode, Type>) =
                NullabilityAssumptionsBuilder(relatedReferenceTypes).injectNullabilityAssumptions()
        ...
        private inner class NullabilityAssumptionsBuilder(val relatedReferenceTypes: Map<AbstractInsnNode, Type>) {
