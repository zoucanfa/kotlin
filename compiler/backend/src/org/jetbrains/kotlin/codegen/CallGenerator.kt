...
interface CallGenerator {
    ...
    class DefaultCallGenerator(private val codegen: BaseExpressionCodegen) : CallGenerator {
    ...
    fun genCallInner(callableMethod: Callable, resolvedCall: ResolvedCall<*>?, callDefault: Boolean, codegen: BaseExpressionCodegen)
