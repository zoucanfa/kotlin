...
class TreePathResolverCacheByClassId(private val javac: JavacWrapper) {
    ...
    private fun tryToResolveInJavaLang(pathSegments: List<String>): JavaClass? {
    ...
    private fun tryToResolveByFqName(pathSegments: List<String>): JavaClass? {
    ...
    private fun classId(packageName: String = "<root>", className: String) =
            if (packageName != "<root>")
