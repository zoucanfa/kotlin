...
internal class DelegatingDataFlowInfo private constructor(
    ...
    constructor(): this(null, mapOf(), newTypeInfo(), null)
    ...
    override fun establishSubtyping(
        ...
        val newNullabilityInfo = if (type.isMarkedNullable) EMPTY_NULLABILITY_INFO else builder.toMap()
    ...
    companion object {
        private val EMPTY_NULLABILITY_INFO = mapOf<DataFlowValue, Nullability>()
