...
//    assert(first.a == first2.a) { "a" }
//    assert(first.b == first2.b) { "b" }
//    assert(first.c == first2.c) { "c" }
//    assert(first.d == first2.d) { "d" }
//    assert(first.e == first2.e) { "e" }
//    assert(first.f == first2.f) { "f" }
//    assert(first.g == first2.g) { "g" }
//    assert(first.h == first2.h) { "h" }

    System.err.println(first.toString())
    System.err.println(first2.toString())
