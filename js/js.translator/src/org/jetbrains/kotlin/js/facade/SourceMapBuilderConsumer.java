...
public class SourceMapBuilderConsumer implements SourceLocationConsumer {
    ...
    private void addMapping(@Nullable Object sourceInfo) {
        ...
        if (sourceInfo instanceof PsiElement) {
            ...
            mappingConsumer.addMapping(location.getFile(), null, () -> null, location.getStartLine(), location.getStartChar());
        }
            ...
            mappingConsumer.addMapping(location.getFile(), locationWithSource.getIdentityObject(), contentSupplier,
