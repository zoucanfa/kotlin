...
package org.jetbrains.kotlin.jvm.lightClasses.structure.builder
...
import org.jetbrains.kotlin.jvm.lightClasses.structure.classes.getOutermostClassOrObject
...
class LightClassDataProviderForClassOrObject(
    ...
    private fun computeLightClassData(): LightClassDataHolder.ForClass {
        ...
        return LazyLightClassesSupport.getInstance(classOrObject.project).createDataHolderForClass (classOrObject) {
            constructionContext ->
...
sealed class LightClassDataProviderForFileFacade constructor(
    ...
    private fun computeLightClassData(files: Collection<KtFile>): LightClassDataHolder.ForFacade {
        return LazyLightClassesSupport.getInstance(project).createDataHolderForFacade(files) {
            constructionContext ->
