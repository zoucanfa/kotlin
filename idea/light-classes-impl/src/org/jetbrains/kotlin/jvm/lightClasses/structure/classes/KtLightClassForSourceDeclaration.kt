...
package org.jetbrains.kotlin.jvm.lightClasses.structure.classes
...
import org.jetbrains.kotlin.jvm.lightClasses.structure.builder.LightClassData
import org.jetbrains.kotlin.jvm.lightClasses.structure.builder.LightClassDataHolder
import org.jetbrains.kotlin.jvm.lightClasses.structure.builder.LightClassDataProviderForClassOrObject
import org.jetbrains.kotlin.jvm.lightClasses.structure.elements.FakeFileForLightClass
import org.jetbrains.kotlin.jvm.lightClasses.structure.elements.KtLightIdentifier
import org.jetbrains.kotlin.jvm.lightClasses.structure.elements.KtLightPsiReferenceList
import org.jetbrains.kotlin.jvm.lightClasses.structure.elements.KtLightSimpleModifierList
import org.jetbrains.kotlin.jvm.lightClasses.structure.util.ImpreciseResolveResult
import org.jetbrains.kotlin.jvm.lightClasses.structure.util.ImpreciseResolveResult.UNSURE
import org.jetbrains.kotlin.jvm.lightClasses.structure.util.LightClassUtil
import org.jetbrains.kotlin.jvm.lightClasses.structure.util.hasInterfaceDefaultImpls
...
abstract class KtLightClassForSourceDeclaration(protected val classOrObject: KtClassOrObject)
    ...
    protected fun getDescriptor(): ClassDescriptor? {
        return LazyLightClassesSupport.getInstance(project).resolveToDescriptor(classOrObject) as? ClassDescriptor
    }
